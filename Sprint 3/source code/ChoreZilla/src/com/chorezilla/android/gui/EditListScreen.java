...
import com.chorezilla.android.CheckList;
import com.chorezilla.android.ChoreItem;
import com.chorezilla.android.ListCollection;
import com.chorezilla.android.ListXMLParser;
...
public class EditListScreen extends Activity implements OnItemSelectedListener
{
	...
	public void onItemSelected(AdapterView<?> parent, View v, int position, long id) 
	{
		...
		else if(spinnerPos == ls.getAdapter().getCount() - 1)
		{
			...
			alertDialog.setTitle("Add a List").setMessage("Enter a List Name:").setView(input);

			alertDialog.setPositiveButton("Add List", 
					new DialogInterface.OnClickListener() 
			{
				public void onClick(DialogInterface dialog, int which) 
				{
					theCollection.addList(new CheckList(input.getText().toString(), "bmsalm")); //!!!HARDCODED OWNER NAME
					populateListSpinner();
					ls.setSelection(ls.getAdapter().getCount()-2);
				}
			});
